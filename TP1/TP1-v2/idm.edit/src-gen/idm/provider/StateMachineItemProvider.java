...
/**
 * This is the item provider adapter for a {@link idm.StateMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateMachineItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						IdmPackage.Literals.STATE_MACHINE__STATE, true, false, true, null, null, null));
	}
	...
	protected void addTransitionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_StateMachine_transition_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_StateMachine_transition_feature",
								"_UI_StateMachine_type"),
						IdmPackage.Literals.STATE_MACHINE__TRANSITION, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_StateMachine_name_feature",
								"_UI_StateMachine_type"),
						IdmPackage.Literals.STATE_MACHINE__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(IdmPackage.Literals.STATE_MACHINE__STATE);
			childrenFeatures.add(IdmPackage.Literals.STATE_MACHINE__TRANSITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(IdmPackage.Literals.STATE_MACHINE__STATE, IdmFactory.eINSTANCE.createState()));

		newChildDescriptors.add(createChildParameter(IdmPackage.Literals.STATE_MACHINE__TRANSITION,
				IdmFactory.eINSTANCE.createTransition()));
	}

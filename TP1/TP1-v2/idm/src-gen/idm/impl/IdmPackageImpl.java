...
public class IdmPackageImpl extends EPackageImpl implements IdmPackage {
	...
	public static IdmPackage init() {
		if (isInited)
			return (IdmPackage) EPackage.Registry.INSTANCE.getEPackage(IdmPackage.eNS_URI);

		// Obtain or create and register package
		IdmPackageImpl theIdmPackage = (IdmPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof IdmPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new IdmPackageImpl());
